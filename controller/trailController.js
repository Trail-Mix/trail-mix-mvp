...
trailController.getTrails = (req, res, next) => {
    fetch('https://www.hikingproject.com/data/get-trails?lat=34.045023&lon=-118.361273&maxDistance=1&maxResults=25&key=200597455-cfbe6650f3776f2f486ae788a2ecf16b')
    .then(res => res.json())
    .then(json => {
